...
class FSOConSaleControllers(http.Controller):
    ...
    @http.route('/fso_con_sale/create/<int:spenden_id>', type='json', auth="user", website=True)
    def fso_con_sale_create(self, spenden_id, update_existing_record=False, **post):
        """
    ...
    @http.route('/fso_con_sale/update/<int:spenden_id>', type='json', auth="user", website=True)
    def fso_con_sale_update(self, spenden_id, **post):
        """
    ...
    @http.route('/fso_con_sale/read/<int:spenden_id>', type='json', auth="user", website=True)
    def fso_con_sale_read(self, spenden_id=False, record=False, **post):
        """
