...
class SaleOrder(orm.Model):
    ...
    def _check_carrier_quotation(self, cr, uid, order, force_carrier_id=None, context=None):
        ...
        # not.
        #
        # Therefore i did a rewrite of this mehtod here - it may not be already 100% exaclty what the original version
        # does because i did not understand what the "find in grid" stuff really does. TODO: check grid stuff :)
